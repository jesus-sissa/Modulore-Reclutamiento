Public Class frm_DoctosRequeridos
    ...
    Private Sub frm_DoctosRequeridos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Cn_Reclutamiento.fn_DoctosRequeridos_LlenarLista(lsv_Catalogo) Then
    ...
    Private Sub btn_Baja_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Baja.Click
        ...
        If lsv_Catalogo.SelectedItems(0).SubItems(1).Text = "ACTIVO" Then
            Cn_Reclutamiento.fn_DoctosRequeridos_CambiarStatus(lsv_Catalogo.SelectedItems(0).Tag, "B")
        Else
            Cn_Reclutamiento.fn_DoctosRequeridos_CambiarStatus(lsv_Catalogo.SelectedItems(0).Tag, "A")
        End If
        'Aqui se actualiza la lista
        lsv_Catalogo.Items.Clear()
        Cn_Reclutamiento.fn_DoctosRequeridos_LlenarLista(lsv_Catalogo)
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        If Tab_Nuevo.Text = "Nuevo" Then
            ...
            If Not Cn_Reclutamiento.fn_DoctosRequeridos_Validar(tbx_Descripcion.Text) Then
            ...
            If Cn_Reclutamiento.fn_DoctosRequeridos_Nuevo(tbx_Descripcion.Text) Then
        ...
        Else
            ...
            If Cn_Reclutamiento.fn_DoctosRequeridos_Actualizar(lsv_Catalogo.SelectedItems(0).Tag, tbx_Descripcion.Text, "A") Then
