...
Public Class rpt_Familiares
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_Familiares.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Familiares
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Familiares = New rpt_Familiares()
        rpt.Site = Me.Site
        Return rpt
    End Function
