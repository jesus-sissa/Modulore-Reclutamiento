...
Public Class rpt_Solicitud1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_Solicitud1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Solicitud1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Solicitud1 = New rpt_Solicitud1()
        rpt.Site = Me.Site
        Return rpt
    End Function
