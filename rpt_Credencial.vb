...
Public Class rpt_Credencial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_Credencial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Credencial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Credencial = New rpt_Credencial()
        rpt.Site = Me.Site
        Return rpt
    End Function
