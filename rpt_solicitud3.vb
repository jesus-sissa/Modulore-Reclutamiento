...
Public Class rpt_solicitud3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_solicitud3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_solicitud3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_solicitud3 = New rpt_solicitud3()
        rpt.Site = Me.Site
        Return rpt
    End Function
