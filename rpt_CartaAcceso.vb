...
Public Class rpt_CartaAcceso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_CartaAcceso.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FechaRegistro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_CartaAcceso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_CartaAcceso = New rpt_CartaAcceso()
        rpt.Site = Me.Site
        Return rpt
    End Function
