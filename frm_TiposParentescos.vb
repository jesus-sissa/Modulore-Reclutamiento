...
Public Class frm_TiposParentescos


    Private Sub frm_TiposParentescos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Aqui se llena la lista
        If Not Cn_Reclutamiento.fn_TiposParentescos_LlenarLista(lsv_Catalogo) Then
    ...
    Private Sub frm_TiposParentescos_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        If Tab_Nuevo.Text = "Nuevo" Then
            ...
            If Not Cn_Reclutamiento.fn_TipoParentesco_Validar(tbx_Descripcion.Text) Then
                'En caso de que Tipo de Parentesco ya exista en la base de datos
                MsgBox("Parentesco ya existe.", MsgBoxStyle.Critical, frm_MENU.Text)
            ...
            If Cn_Reclutamiento.fn_TipoParentesco_Nuevo(tbx_Descripcion.Text) Then
        ...
        Else
            ...
            If Cn_Reclutamiento.fn_TipoParentesco_Actualizar(lsv_Catalogo.SelectedItems(0).Tag, tbx_Descripcion.Text, "A") Then
        ...
        Cn_Reclutamiento.fn_TiposParentescos_LlenarLista(lsv_Catalogo)
        If lsv_Catalogo.Items.Count = 0 Then
            btn_Exportar.Enabled = False
    ...
    Private Sub btn_Baja_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Baja.Click
        'Aqui se filtra cuando el Tipo Parentesco esta Activo o Baja
        If lsv_Catalogo.SelectedItems(0).SubItems(1).Text = "ACTIVO" Then
            Cn_Reclutamiento.fn_TipoParentesco_CambiarStatus(lsv_Catalogo.SelectedItems(0).Tag, "B")
        Else
            Cn_Reclutamiento.fn_TipoParentesco_CambiarStatus(lsv_Catalogo.SelectedItems(0).Tag, "A")
        End If
