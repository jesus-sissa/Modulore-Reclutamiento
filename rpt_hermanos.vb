...
Public Class rpt_hermanos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_hermanos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_hermanos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_hermanos = New rpt_hermanos()
        rpt.Site = Me.Site
        Return rpt
    End Function
