...
Public Class rpt_solicitud2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_solicitud2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_solicitud2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_solicitud2 = New rpt_solicitud2()
        rpt.Site = Me.Site
        Return rpt
    End Function
