...
Public Class rpt_CredencialR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_CredencialR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_CredencialR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_CredencialR = New rpt_CredencialR()
        rpt.Site = Me.Site
        Return rpt
    End Function
