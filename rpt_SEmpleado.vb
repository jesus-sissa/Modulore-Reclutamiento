...
Public Class rpt_SEmpleado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_SEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_SEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_SEmpleado = New rpt_SEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
