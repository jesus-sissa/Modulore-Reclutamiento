...
Public Class rpt_FichaTecnica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Reclutamiento.rpt_FichaTecnica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_FichaTecnica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_FichaTecnica = New rpt_FichaTecnica()
        rpt.Site = Me.Site
        Return rpt
    End Function
