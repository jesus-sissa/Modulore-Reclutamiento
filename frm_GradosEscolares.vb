...
Public Class frm_GradosEscolares

    Private Sub frm_GradosEscolares_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Aqui se llena la lista
        If Not Cn_Reclutamiento.fn_GradosEscolares_LlenarLista(lsv_Catalogo) Then
    ...
    Private Sub frm_GradosEscolares_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub btn_Exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Exportar.Click
        'Valida que tenga acceso a esta Boton
        If Not FuncionesGlobales.fn_ValidaPermisoControl(sender.tag) Then Exit Sub
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        If Tab_Nuevo.Text = "Nuevo" Then
            ...
            If Not Cn_Reclutamiento.fn_GradosEscolares_Validar(tbx_Descripcion.Text) Then
                'En caso de que Grado escolar ya exista en la base de datos
                MsgBox("Grado Escolar ya existe.", MsgBoxStyle.Critical, frm_MENU.Text)
            ...
            If Cn_Reclutamiento.fn_GradosEscolares_Nuevo(tbx_Descripcion.Text) Then
        ...
        Else
            ...
            If Cn_Reclutamiento.fn_GradosEscolares_Actualizar(lsv_Catalogo.SelectedItems(0).Tag, tbx_Descripcion.Text, "A") Then
                'En caso de que se haya hecho la transaccion
                Cn_Reclutamiento.fn_Menu_Progreso(30)
        ...
        Cn_Reclutamiento.fn_GradosEscolares_LlenarLista(lsv_Catalogo)
        If lsv_Catalogo.Items.Count = 0 Then
            btn_Exportar.Enabled = False
        Else
            btn_Exportar.Enabled = True
    ...
    Private Sub btn_Baja_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Baja.Click
        ...
        'Aqui se filtra cuando la Alerta esta activa o baja
        If lsv_Catalogo.SelectedItems(0).SubItems(1).Text = "ACTIVO" Then
            Cn_Reclutamiento.fn_GradosEscolares_CambiarStatus(lsv_Catalogo.SelectedItems(0).Tag, "B")
        Else
            Cn_Reclutamiento.fn_GradosEscolares_CambiarStatus(lsv_Catalogo.SelectedItems(0).Tag, "A")
        End If
